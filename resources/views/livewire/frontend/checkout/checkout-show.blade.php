            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            ...
                            <hr>
                            <small>Items will be delivered in 3 - 7 days.</small>
                            <br/>
                            <small>Nexus-2-Go Delivery</small>
                        </div>
                    </div>
                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            <hr>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label> Available Payment Mode: </label>
                ...
                @else
                        <div class ="card card-body shadow text-center p-md-5">
                            ...
                            <a href ="{{url('collections')}}" class ="btn btn-warning">Get now</a>
                        </div>
                    @endif
            </div>
        </div>
